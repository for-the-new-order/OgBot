...
var VersionCommand = /** @class */ (function (_super) {
    ...
    function VersionCommand() {
        ...
        _this.supportedCommands = ['version'];
        return _this;
    }
    VersionCommand.prototype.handle = function (message, commandArgs) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, message.channel.send(botName + ": " + botVersion)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
